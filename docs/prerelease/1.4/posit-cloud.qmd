...
{{< include ../../publishing/_cli-options.md >}}
...
If you are using the RStudio IDE, there is also support for push-button publishing to Posit Cloud. Use the publish button <kbd>![](../../publishing/images/publish-button.png){width="23" height="20"}</kbd> from the source editor or viewer pane to publish a document or a website.
...
{{< include ../../publishing/_freeze-basics.md >}}
...
2.  Add the token secret to your repository's action **Secrets** (accessible within repository **Settings**). You will see a **New repository secret** button at the top right:
    ...
    ![](../../publishing/images/gh-new-repository-secret.png){.border}

    Click the button and add the API Key from step 1 as a secret named `POSIT_CLOUD_SECRET`:

    ![](../../publishing/images/gh-action-posit-cloud-secret.png){.border}
...
{{< include ../../publishing/_ci-execute-requirements.md >}}
